...
import { rescheduleTicketsBatch } from '@/features/tickets/api/tickets-api';
import { rescheduleMantenimientosBatch } from '@/features/mantenimientos/api/mantenimientos-api';
...
export const BacklogRescheduleDrawer = ({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Selección dinámica del endpoint basado en el scope actual
            const rescheduleFn = scope === 'mantenimientos' ? rescheduleMantenimientosBatch : rescheduleTicketsBatch;
