...
export default function HoyTodasPage() {
    ...
    const [vistaActiva, setVistaActiva] = useState(getDefaultHoyVista('general'));
    ...
    const queryPayload = useMemo(() => {
        ...
        Object.assign(params, buildHoyDateParams(vistaActiva, 'general'));
    ...
    const totalVistaActiva = getMetricTotalForVista(metricas, vistaActiva, 'general');
