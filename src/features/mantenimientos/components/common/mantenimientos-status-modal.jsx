...
//
import { TicketStartModal } from '@/features/common/components/status-modals/ticket-start-modal';
import { TicketProgressModal } from './status-modals/ticket-progress-modal';
import { TicketPausaModal } from '@/features/common/components/status-modals/ticket-pausa-modal';
import { TicketCheckModal } from '@/features/common/components/status-modals/ticket-check-modal';
import { TicketRechazadoModal } from '@/features/common/components/status-modals/ticket-rechazado-modal';
...
export { TicketStatusModal as MantenimientosStatusModal };
