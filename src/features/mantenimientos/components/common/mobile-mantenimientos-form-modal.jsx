...
import { getMinDateHoy, fechaInputToISOLocal, isoToDateInput, isoToLocalMXTime } from '@/lib/date';
import {
...
export const MobileTicketFormModal = ({
    ...
    const buscarMaquinasRemoto = useCallback(async (query = '') => {
        ...
        try {
            ...
            console.error("Error al buscar máquinas en modal móvil:", err);
        } finally {
