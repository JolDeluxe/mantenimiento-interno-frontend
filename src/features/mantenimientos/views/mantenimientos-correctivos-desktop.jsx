// src/features/mantenimientos/views/mantenimientos-correctivos-desktop.jsx
import { useState } from 'react';
import { MantenimientosTicketTable as CorrectivosTicketTable } from '../components/common/mantenimientos-ticket-table';
import { MantenimientosFilterBar as CorrectivosFilterBar } from '@/features/common/components/ticket-filter-bar';
            ...
            {!loading && (!tickets || tickets.length === 0) ? (
                <div className="mt-8">
                    <TicketsEmptyState
                        ...
                        subtexto="No hay correctivos registrados para este periodo."
                        icon="history"
                    />
                </div>
            ) : (
