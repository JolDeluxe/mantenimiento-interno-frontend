...
export const MantenimientosHoyDesktop = ({
    tickets = [],
    toApproveCount,
    highlightId,
    loading,
    ...
    return (
        <div className="flex flex-col gap-5 relative">
            <div>
                <h2 className="fuente-titulos text-2xl text-marca-primario uppercase tracking-wide">Mantenimientos del Día</h2>
                    ...
                    {agendaTickets.length > 0 && (
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center gap-2 border-b border-slate-200 pb-2">
                                ...
                                <h3 className="font-bold text-slate-800 text-base uppercase">Agenda Programada (Cronológica)</h3>
                            </div>
                            <HoyTicketTable
                    ...
                    {(colaTickets.length > 0 || agendaTickets.length === 0) && (
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center gap-2 border-b border-slate-200 pb-2">
                                ...
                                <h3 className="font-bold text-slate-800 text-base uppercase">Cola de Trabajo (On-Demand / Sin Hora)</h3>
                            </div>
                            <HoyTicketTable
                                tickets={colaTickets}
                                loading={loading}
