...
export const MantenimientosHoyMobile = ({
    tickets = [],
    toApproveCount,
    highlightId,
    loading,
    ...
    return (
        <>
            ...
            <div className={cn('flex flex-col gap-5 px-1 pt-1', 'pb-44')}>
                {loading ? (
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        {agendaTickets.length > 0 && (
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center gap-1.5 border-b border-slate-200/80 pb-1.5 px-0.5">
                                    <Icon name="schedule" size="xs" className="text-marca-secundario shrink-0" />
                                    <span className="font-bold text-slate-800 text-xs uppercase tracking-wide">Agenda Programada</span>
                                </div>
                        ...
                        {(colaTickets.length > 0 || agendaTickets.length === 0) && (
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center gap-1.5 border-b border-slate-200/80 pb-1.5 px-0.5">
                                    <Icon name="view_list" size="xs" className="text-slate-500 shrink-0" />
                                    <span className="font-bold text-slate-800 text-xs uppercase tracking-wide">Cola de Trabajo (Sin Hora)</span>
                                </div>
