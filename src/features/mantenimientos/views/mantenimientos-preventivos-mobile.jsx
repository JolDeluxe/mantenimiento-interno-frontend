...
import { MobileMantenimientosFilterBar as MobilePreventivosFilterBar } from '../components/common/mobile-mantenimientos-filter-bar';
import { MantenimientosTicketTable as PreventivosTicketTable } from '../components/common/mantenimientos-ticket-table';
import { MantenimientosTicketCard as PreventivosTicketCard } from '../components/common/mantenimientos-ticket-card';
...
export const MantenimientosPreventivosMobile = ({
    tickets,
    loading,
    submitting,
    currentUser,
    ...
    return (
        <>
            ...
            <MobileTicketFormModal isOpen={Boolean(editTarget)} onClose={() => setEditTarget(null)} ticketAEditar={editTarget} currentUser={currentUser} tecnicos={tecnicos} isSubmitting={submitting} onSuccess={async (payload) => { await onSave(editTarget.id, payload); setEditTarget(null); }} scope="mantenimientos" />
