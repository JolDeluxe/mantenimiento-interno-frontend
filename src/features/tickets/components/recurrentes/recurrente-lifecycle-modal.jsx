...
const copy = {
    ...
    archivar: ['Archivar regla', 'La regla se retira de los listados operativos y conserva su historial.', 'archive', 'cancelar'],
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} className="w-full max-w-md">
            ...
            <ModalFooter>
                ...
                <Button type="button" variant={variant} onClick={onConfirm} disabled={submitting} isLoading={submitting}>Confirmar</Button>
            </ModalFooter>
        </Modal>
    );
};
